...
1. In order to use the Adobe I/O Events you will need to create a project on Adobe I/O Console. [Follow the steps listed in Getting Started page to create a project](../../getting-started/index.md) if you haven't created one yet.
